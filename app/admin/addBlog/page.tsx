    ...
    return (
        <div className="flex flex-col w-full justify-start pb-2"> {/* px-8 md:px-24*/}
            ...
            <div className="flex flex-col w-full max-w-screen-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <input type="submit" value="Sauvegarder" className="btn-secondary self-start"/>
...
//     return (
//         <main className="flex flex-col w-full justify-start pb-2"> {/* px-8 md:px-24*/}
//             <FormHeader title = {"Ajouter un post de blog"} url = {"/admin/adminBlogPost"} />
...
//                             <input required pattern = {"[a-z]^-"} className="border-2 flex-grow rounded-md p-1 m-2" type="text" id="slug" placeholder="Slug (URI)" onChange={ (e) => setSlug(e.target.value) }></input>
//                         </div>
//                     </div>
